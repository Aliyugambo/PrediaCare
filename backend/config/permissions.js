...
const PERMISSIONS = {
  ...
  // Birth Records permissions
  MANAGE_BIRTH_RECORDS: 'manage_birth_records',
  VIEW_BIRTH_RECORDS: 'view_birth_records',

  // Death Records permissions
  MANAGE_DEATH_RECORDS: 'manage_death_records',
  VIEW_DEATH_RECORDS: 'view_death_records',
};
...
const ROLE_PERMISSIONS = {
  ...
  admin: [
    ...
    PERMISSIONS.VIEW_BLOOD_BANK,
     ...
     // Birth Records permissions
     PERMISSIONS.MANAGE_BIRTH_RECORDS,
     PERMISSIONS.VIEW_BIRTH_RECORDS,
     // Death Records permissions
     PERMISSIONS.MANAGE_DEATH_RECORDS,
     PERMISSIONS.VIEW_DEATH_RECORDS,
    // Staff permissions
...
diagnostic: [
  ...
  // Blood Bank Staff - can manage blood bank inventory, donors, issues, and view stats
  bloodbank: [
    PERMISSIONS.VIEW_BLOOD_BANK,
    PERMISSIONS.MANAGE_BLOOD_BANK,
  ],
